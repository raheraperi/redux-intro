...
var addImg = exports.addImg = function addImg(imgURL) {
  return {
    type: 'ADD_IMAGE',
    id: imgURLId++,
    imgURL: imgURL
...
var _images = __webpack_require__(71);
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_AddImage2.default, null)
    )
  );
};
...
function submitImage(e, dispatch) {
  if (e.keyCode === 13) {
    dispatch((0, _actions.addImg)(e.currentTarget.value));
    e.currentTarget.value = '';
  }
}
...
exports.default = (0, _reactRedux.connect)()(AddImage);
